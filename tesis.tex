...
\usepackage[left=3.5cm,right=2cm,top=2.5cm,bottom=2cm,includehead,includefoot]{geometry}  %margenes según pauta de la U
\usepackage{setspace}
...
%\usepackage{hyperref}
\usepackage{xcolor}
\usepackage{tikz}% para graficar en Latex
\usetikzlibrary{babel,positioning,calc}
\usepackage{afterpage}
\usepackage{float} %Imágenes Donde yo quiera :p
...
\pagestyle{headings}%cabeceras de Pagina
...
\textmd{Tesis para optar al\\ Título Profesional de Ingeniero Civil Informático}
