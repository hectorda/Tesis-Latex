...
Para la sincronización temporal fue utilizada la correlación cruzada, con la cual se obtiene el retraso(lag) entre las señales, y para ello fue necesario sub-muestrear los datos del dispositivo (decimate en octave)  a 100hz.
...
Sin mas que acotar a continuación se encuentra la definición de todas las ecuaciones utilizadas para obtener los cálculos  en tabla de Resultados.
