...
Las declaraciones son objeto de debate sobre la normalización de estabilometría acordados por el ISPGR (International Society for Posture and Gait Research).
...
El ángulo entregado por el dispositivo es afectado por cualquier tipo de inclinación, el propio IMU o la caja contenedora pueden estar inclinados un par de grados en algún sentido. Realizando una prueba con un inclinómetro analógico es posible comparar cuan fiable es el ángulo entregado por el dispositivo.
Para propósitos de prueba se ubicara el dispositivo en  4 ángulos distintos, midiendo con ambos instrumentos, para luego contrastarlos.
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.3]{images/inclinometroVsDispositivo}
	\caption{Comparativa Ángulo Dispositivo vs Inclinómetro Analógico}
	\label{fig:inclinometroVsDispositivo}
\end{figure}
...
\begin{table}[H]
	\centering
		\begin{tabular}{|c|c|c|}
			\hline
			\textbf{Inclinómetro Análogo (Ángulo)} & \multicolumn{1}{l|}{\textbf{Dispositivo (Ángulo Promedio)}} & Ángulo Diferencia(Disp-Inc) \\ \hline
			1                                      & 4.8362                                                      & 3.8362                     \\ \hline
			3                                      & 6.8912                                                      & 3.8912                     \\ \hline
			5                                      & 8.5621                                                      & 3.5621                     \\ \hline
			7                                      & 10.618                                                      & 3.618                      \\ \hline
			5                                      & 8.3565                                                      & 3.3565                     \\ \hline
			3                                      & 6.3586                                                      & 3.3586                     \\ \hline
			1                                      & 4.3499                                                      & 3.3499                     \\ \hline
		\end{tabular}
		\caption{Comparativa Diferencias}
		\label{table:inclinometroVsDispositivo}
\end{table}
Como muestran la Figura \ref{fig:inclinometroVsDispositivo} y la Tabla \ref{table:inclinometroVsDispositivo} el dispositivo se encuentra con unos grados mas que el incinómetro, que a la vez son en su mayoría constantes.
\newpage
