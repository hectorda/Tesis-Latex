...
A partir de la información proveniente del Proceso
...
\subsection{Comparativa de Filtros}
...
\subsection{Comparación métodos Cálculo Desplazamiento}
Para comparar la aproximación que generan ambos métodos fueron analizados utilizando una altura de 100 centímetros.

A continuación se presenta una tabla \ref{table:comparacionDesplazamiento} con valores de ejemplo para comparar el comportamiento de las dos fórmulas para el cálculo del desplazamiento, y además un gráfico\ref{fig:comparacionDesplazamiento} para comparar la diferencia entre ellos y ver el comportamiento.
	...
	\begin{subfigure}{.5\textwidth}
		\scalebox{0.75}{
			\begin{tabular}{|c|c|c|c|}
				...
				\hline
				\label{table:comparacionDesplazamiento}
			\end{tabular}
		}
	\end{subfigure}
	\begin{subfigure}{.5\textwidth}
...
\begin{itemize}
	\item \textbf{Prueba Dispositivo Espalda:} En la siguiente prueba el dispositivo fue ubicado en la espalda, en zona las vértebras lumbares del sujeto. Se realiza la medición en la Plataforma Kistler en conjunto con el \nombreDispositivo creado con objetivo de Tesis.
