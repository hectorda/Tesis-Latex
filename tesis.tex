...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\linewidth]{images/BalanceSD}
...
\subsubsection{Cálculo del COP}
El COP en las plataformas de fuerza en general es el promedio de las fuerzas aplicadas en cada uno de los piezoeléctricos (sensores de presión/fuerza) tal como lo demuestra la Figura (\ref{fig:calculoCOP}).
