...
\subsection{Referencia Dispositivo y Sensor}
...
Tal como se aprecia en la figura (\ref{fig:referenciaDisp}), la flecha roja de referencia apunta paralelamente, en el sentido positivo del eje y (MPU6050).
...
El ángulo de inclinación modelo pendulo invertido es la variable fundamental de este sistema.
...
\subsubsection{Cálculo Ángulo con Acelerómetro} Es posible usar el acelerómetro como inclinómetro. Este nos entrega el ángulo con gran exactitud espacial, pero es demasiado sensible a cualquier variación en la aceleración en cualquiera de sus 3 ejes y estas variaciones pueden no ser producto tan solo de la fuerza gravitacional, por ende ser generan medidas erráticas debido a los cambios de aceleración constantes que son generados al girar/mover la IMU.
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{images/kalman-filter.png} 
...
Basado en la premisa que la posición bípeda-quieta puede ser representada como un péndulo invertido, entonces el movimiento pendular de un sujeto en las coordenadas antero-posterior y medio-lateral puede ser obtenida a partir de relaciones geométricas(trigonometría), con ello obtener el desplazamiento.
